  ...
  const features = [
    {
      ...
      description:
        "Klien gak perlu simpan nomor. Klik Pesan, data langsung terkirim ke WA Admin dengan format rapi.",
    ...
    },
    {
      ...
      description:
        "Logo, warna, font - semuanya bisa disesuaikan dengan brand kamu. Bikin customer percaya!",
    ...
    },
    {
      ...
      description:
        "Dengan mengambil paket Bisnis kamu bisa langsung termudahkan dalam mengolah data klienmu.",
    ...
    },
    {
      ...
      description: "Dapatkan link eksklusif: eformku.id/namavendor. ",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-200 max-w-7xl mx-auto">
            Semua fitur dirancang untuk mempermudah calon klienmu dan
            mempermudah Admin untuk berinteraksi dengan klien.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-fr">
          ...
          <div className="lg:col-span-2">
            <div
              className={`bg-gradient-to-br ${features[0].gradient} rounded-3xl p-8 md:p-10 h-full flex flex-col justify-between hover:shadow-2xl transition-shadow`}
            >
              <div>
              ...
              <div className="mt-8 flex items-center gap-4">
                <div className="flex-1 bg-white/20 backdrop-blur rounded-lg p-4">
                  <p className="text-white text-sm">
                    Format pesan rapi & profesional
                  </p>
                </div>
                <div className="flex-1 bg-white/20 backdrop-blur rounded-lg p-4">
                  <p className="text-white text-sm">
                    Langsung klik, langsung kirim
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:row-span-1">
            <div
              className={`bg-gradient-to-br ${features[1].gradient} rounded-3xl p-8 h-full flex flex-col hover:shadow-2xl transition-shadow`}
            >
              <div className="w-16 h-16 bg-white/20 backdrop-blur rounded-2xl flex items-center justify-center mb-6">
                {features[1].icon}
              </div>
              <h3 className="text-2xl mb-4 text-white">{features[1].title}</h3>
          ...
          <div className="lg:row-span-1">
            <div
              className={`bg-gradient-to-br ${features[2].gradient} rounded-3xl p-8 h-full flex flex-col hover:shadow-2xl transition-shadow`}
            >
              <div className="w-16 h-16 bg-white/20 backdrop-blur rounded-2xl flex items-center justify-center mb-6">
                {features[2].icon}
              </div>
              ...
              <p className="text-[#3D3B8E]/90">{features[2].description}</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            <div
              className={`bg-gradient-to-br ${features[3].gradient} rounded-3xl p-8 h-full flex flex-col md:flex-row items-center gap-6 hover:shadow-2xl transition-shadow`}
            >
              ...
              <div className="bg-white/20 backdrop-blur rounded-lg px-6 py-3 flex-shrink-0">
                <p className="text-white text-sm">eformku.id/namavendor</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6 text-center">
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:border-white/20 transition-all hover:scale-105">
            ...
            <p className="text-gray-300 text-sm">
              90% pelanggan order dari HP, kami tau itu!
            </p>
          </div>
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:border-white/20 transition-all hover:scale-105">
            <div className="text-3xl mb-2 grid place-items-center">
            ...
            <p className="text-gray-300 text-sm">
              Ada masalah? Chat WA langsung dibalas!
            </p>
          </div>
        </div>
      </div>
